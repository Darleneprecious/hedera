...
//     icons: [typeof window !== 'undefined' ? window.location.origin + "/favicon.ico" : "/favicon.ico"], url: "http://localhost:3000",
// };
...
//     const result = await instance.signTransaction(AccountId.fromString(accountIdForSigning), message)
...
//             result = await instance.requestTransaction(AccountId.fromString(accountIdForsigning), {
//                 type: "CONTRACT_CALL",
...
//             result = await instance.sendTransaction(AccountId.fromString(accountIdForsigning), {
//                 type: "CONTRACT_CALL",
//                 contractId: contractId,
//                 functionName: functionName,
//                 functionParameters: functionParameters,
...
//             console.log('No suitable transaction method found. Available methods: ', Object.getOwnProper)
...
//                 getAddress: (index: number) => `0x00000000000000000${Math.floor(Math.random)}`
